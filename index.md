...
| Combinational Logic Circuits <br> (Week 3) Chap.3 <br> Data types & Bitwise in C | Review Karnaugh Maps (Reading) <br> [Combinational Logic Devices](lectures/logic2.pdf) <br> [Decoders-Video]  [Multiplexers-Video] <br> [Cedar Logic Circuits-Week3](lectures/Set2.cdl) [Logisim Circuits Week3](lectures/Set2.zip) <br> [Circuits with Feedback-FlipFlops](lectures/logic3.pdf) [Video] <br> [Review: Data rep and Bitwise in C](lectures/bitwise.pdf)| 
