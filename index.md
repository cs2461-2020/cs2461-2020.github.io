...
| Sequential Logic (Week 4-5) <br> Chapter 3| [Sequential Logic & Finite State Machines](lectures/seqlogic.pdf) [Clocked Circuits - Flip Flops (Video)](https://youtu.be/MpwEzpyll1w<br>) <br> [CedarLogic-Examples of Sequential Logic Devices](lectures/Set3.cdl)<br> [Finite State Machine Design(video)] <br> [CedarLogic-Examples: Finite State Machines](lectures/Set4.cdl)|
